...
//   <Link 
//     to={to}
//     className="text-white hover:text-purple-300 transition duration-300 px-2 py-1"// hover:bg-purple-500"
//   >
//     {children}
//   </Link>
// );
...
//             <NavLink to="/excelUpload">UploadFile</NavLink>
//           </div>
//         </div>
...
//           <MobileNavLink to="/favorites">My Favorites</MobileNavLink>
//           <MobileNavLink to="/excelUpload">UploadFile</MobileNavLink>
//         </div>
//       </div>
//     </nav>
//   );
...
const Navigation = ({ theme }) => {
  ...
  const adminEmails = [
    "ch.mariyam06@gmail.com",
    "seemabhassan05@gmail.com",
  ];
    ...
    <nav className={`${navStyles[theme]} p-4 shadow-lg`}>
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex items-center space-x-6 mb-4 md:mb-0">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {isAdmin && <NavLink to="/excelUpload">UploadFile</NavLink>}
          </div>
        </div>
      ...
      <div className="md:hidden bg-purple-900 mt-2 py-2 px-4 rounded-lg">
        <div className="flex flex-col space-y-2">
          ...
          {isAdmin && <MobileNavLink to="/excelUpload">UploadFile</MobileNavLink>}
        </div>
      </div>
    </nav>
  );
